...
export const metadata: Metadata = {
  title: "Contact Albert Construction | Free Quote | London",
  description:
    "Get a free site survey and fixed-price quotation for your loft conversion, extension, or renovation in London. Call 07478 606 507.",
  alternates: {
    canonical: "https://albertconstructionltd.co.uk/contact",
  },
  openGraph: {
    title: "Contact Albert Construction | Free Quote | London",
    description:
      "Get a free site survey and fixed-price quotation for your loft conversion, extension, or renovation in London. Call 07478 606 507.",
    url: "https://albertconstructionltd.co.uk/contact",
  },
  twitter: {
    title: "Contact Albert Construction | Free Quote | London",
    description:
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <a
                ...
                aria-label="Message Albert Construction on WhatsApp"
              >
            ...
            <div>
              ...
              <a
                ...
                aria-label="Email Albert Construction"
              >
            ...
            <div>
              ...
              <p className="text-charcoal/70 text-sm mt-1">
                Serving all areas across London
              </p>
            </div>
            ...
            <div className="bg-surface-container-low rounded-lg p-6 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base text-charcoal">Companies House registered </span>
              </div>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
              ...
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                <span className="text-base text-charcoal">9.7/10 Checkatrade rating (29 reviews)</span>
              </div>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#b87333" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
      ...
      <section className="relative bg-primary py-16 md:py-20 mx-6 mb-20 md:mb-28 rounded-lg overflow-hidden">
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-white/80 text-lg font-body mb-8 max-w-md mx-auto">
            Call Albert Construction directly to discuss your project. No call centres, no sales teams.
          </p>
