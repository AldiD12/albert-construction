...
export const metadata: Metadata = {
  title: "Our Services | Albert Construction",
  description:
    "Loft conversions, extensions, renovations, commercial offices, bathrooms, kitchens & more across London. Free quotes from Albert Construction Ltd.",
  alternates: {
    canonical: "https://albertconstructionltd.co.uk/services",
  },
  openGraph: {
    title: "Our Services | Albert Construction",
    description:
      "Extensions, loft conversions, bathrooms, kitchens, plastering, roofing & renovations in London. Free quotes from Albert Construction.",
    url: "https://albertconstructionltd.co.uk/services",
  },
  twitter: {
    title: "Our Services | Albert Construction",
    description:
...
const services = [
  ...
  },
  {
    ...
    image: "/images/interior_loft_skylight_wood_floor.webp",
  },
  {
    title: "Commercial Offices",
    href: "/services/commercial-offices",
    description:
      "Office fit-outs and commercial refurbishments across London.",
  ...
  },
  {
    ...
    image: "/images/interior_kitchen_white_units_complete.webp",
  },
  {
  ...
  },
  {
    ...
    image: "/images/exterior_extension_rear_garden_wide.webp",
  },
];
      ...
      <section className="px-6 mb-16 md:mb-20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-charcoal leading-relaxed max-w-2xl mx-auto">
            ...
            solutions across London &amp; North West London.
          </p>
        </div>
      </section>
            ...
            {services.map((service) => (
              ...
              >
                <div className="overflow-hidden">
                  <Image
                    src={service.image}
                    alt={`${service.title} by Albert Construction`}
                    width={800}
                    height={450}
