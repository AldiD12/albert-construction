...
export const metadata: Metadata = {
  title: "Privacy Policy | Albert Construction",
  description:
    "Privacy policy for Albert Construction Ltd. Learn how we collect, use, and protect your personal data in compliance with GDPR.",
  alternates: {
    canonical: "https://albertconstructionltd.co.uk/privacy-policy",
  },
  openGraph: {
    title: "Privacy Policy | Albert Construction",
    description:
      "Privacy policy for Albert Construction Ltd. Learn how we collect, use, and protect your personal data in compliance with GDPR.",
    url: "https://albertconstructionltd.co.uk/privacy-policy",
  },
  twitter: {
    title: "Privacy Policy | Albert Construction",
    description:
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-base text-charcoal leading-relaxed">
            <div>
              ...
              <p>
                Albert Construction Ltd (Companies House ) is a building
                contractor. London based.
                Operations Office: London based.
                We are the data controller for personal information collected through this website.
              </p>
              <p className="mt-2">
                Contact: albertconstructionltd@outlook.com | 07478 606 507
              </p>
            </div>
